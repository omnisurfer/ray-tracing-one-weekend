...
inline mat3x3 operator*(const mat3x3 &m1, const mat3x3 &m2) {
	...
	*/
	...
	vec3 a(
		/*row0,0*/ m1.m[0][0] * m2.m[0][0] + m1.m[0][1] * m2.m[0][1] + m1.m[0][2] * m2.m[0][2],
		/*row0,1*/ m1.m[0][0] * m2.m[1][0] + m1.m[0][1] * m2.m[1][1] + m1.m[0][2] * m2.m[1][2],
		/*row0,2*/ m1.m[0][0] * m2.m[2][0] + m1.m[0][1] * m2.m[2][1] + m1.m[0][2] * m2.m[2][2]
	);

	vec3 b(
		/*row1,0*/ m1.m[1][0] * m2.m[0][0] + m1.m[1][1] * m2.m[0][1] + m1.m[1][2] * m2.m[0][2],
		/*row1,1*/ m1.m[1][0] * m2.m[1][0] + m1.m[1][1] * m2.m[1][1] + m1.m[1][2] * m2.m[1][2],
		/*row1,2*/ m1.m[1][0] * m2.m[2][0] + m1.m[1][1] * m2.m[2][1] + m1.m[1][2] * m2.m[2][2]
	);

	vec3 c(
		/*row2,0*/ m1.m[2][0] * m2.m[0][0] + m1.m[2][1] * m2.m[0][1] + m1.m[2][2] * m2.m[0][2],
		/*row2,1*/ m1.m[2][0] * m2.m[1][0] + m1.m[2][1] * m2.m[1][1] + m1.m[2][2] * m2.m[1][2],
		/*row2,2*/ m1.m[2][0] * m2.m[2][0] + m1.m[2][1] * m2.m[2][1] + m1.m[2][2] * m2.m[2][2]
	);
